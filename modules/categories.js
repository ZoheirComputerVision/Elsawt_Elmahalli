const CATEGORIES = [
  ...
  },
  {
    ...
    priority: 2,
    legacy: ['اقتصاد'],
    keywords: ['اقتصاد', 'استثمار', 'تنمية', 'مشروع', 'إسكان', 'طرق', 'مياه', 'بنية تحتية', 'ابتكار'],
  },
  {
    id: 'community',
  ...
  },
  {
    ...
    slug: 'ra2y',
    icon: 'fa-pen-fancy',
    description: 'آراء وتحليلات، افتتاحيات، مقالات رأي، نقاشات فكرية',
    priority: 11,
    legacy: [],
    keywords: ['رأي', 'تحليل', 'افتتاحية', 'نقاش', 'فكر', 'موقف', 'تعليق', 'إضاءة'],
  },
];
